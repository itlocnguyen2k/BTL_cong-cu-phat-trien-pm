...
<head>
    ...
    <title>Quản lý hụi khu vực phí bắc</title>
    ...
    <script type="text/javascript" src="../assets/js/script/jquery-3.6.0.js"></script>
</head>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <span class="hidden-xs">Nguyễn Văn Lộc</span>
                        </a>
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li>
                    <a href="index.php?controller=kyquy">
                        <i class="fa fa-th"></i> <span>Theo dõi ký quỹ</span>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="index.php?controller=orders">
                        <i class="fa fa-th"></i> <span>Duyệt thành viên</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=quytac">
                        <i class="fa fa-th"></i> <span>Quy Tắc</span>
                    </a>
                </li>
                <li>
                    <a href="index.php?controller=mohui">
                        <i class="fa fa-th"></i> <span>Mở hụi</span>
                    </a>
                </li>
                <li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><?php $action=isset($_GET['controller'])?$_GET['controller']:""; echo $action; ?></li>
                <li class="active"><?php $action=isset($_GET['action'])?$_GET['action']:""; echo $action; ?></li>
            </ol>
        </section>
