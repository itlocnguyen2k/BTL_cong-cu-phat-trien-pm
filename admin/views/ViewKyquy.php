...
<div class="col-md-12"> 
    <div style="margin-bottom:5px;">
        <a href="index.php?controller=kyquy&action=create" class="btn btn-primary">Ký quỹ</a>
    </div>   
            ...
            <table class="table table-bordered table-hover">
                ...
                <?php foreach($listRecord as $rows): ?>
                 ...
                 <tr>
                     ...
                     <td style="text-align:center;">
                        <a href="index.php?controller=kyquy&action=update&id=<?php echo $rows->id; ?>">Edit</a>&nbsp;
