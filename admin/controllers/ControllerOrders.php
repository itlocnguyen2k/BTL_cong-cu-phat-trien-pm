<?php 
	...
	class ControllerOrders extends Controller{
		...
		public function update(){
			...
			//goi view, truyen du lieu ra view
			$this->loadView("ViewFormOrders.php",array("record"=>$record,"action"=>$action));
		}
		...
		public function create(){
			//tao bien $action de biet duoc khi an nut submit se dan den dau
			$action = "index.php?controller=orders&action=createPost";
			//goi view, truyen du lieu ra view
			$this->loadView("ViewFormOrders.php",array("action"=>$action));
		}
