<?php 
	trait ModelMember{
		...
		public function modelUpdate(){
			...
			//lay bien ket noi csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("update products set hoten=:var_hoten, ngaysinh=:var_ngaysinh, sdt=:var_sdt, diachi=:var_diachi, gioitinh=:var_gioitinh where id=$id");
			$query->execute(array("var_hoten"=>$hoten,"var_ngaysinh"=>$ngaysinh,"var_sdt"=>$sdt,"var_diachi"=>$diachi,"var_gioitinh"=>$gioitinh));	
			//---
		...
		public function modelCreate(){
			...
			//lay bien ket noi csdl
			$conn = Connection::getInstance();
			$query = $conn->prepare("insert products set hoten=:var_hoten, ngaysinh=:var_ngaysinh, sdt=:var_sdt, diachi=:var_diachi, gioitinh=:var_gioitinh, photo=:var_photo");
