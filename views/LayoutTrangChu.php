...
<title>HỘI PHƯỜNG VỊNH BẮC BỘ</title>
...
<div class="content">
  <div class="container">
    <h1 style="display:none;">HỘI PHƯỜNG</h1>
    <div class="row">
      <div class="col-xs-12 col-md-3">
        <div class="row" style="margin-bottom: 5px;">
          <div class="col-md-12"><img src="assets/image/tietkiem1.jpg" class="img-thumbnail"></div>
        </div>
        <div class="row" style="margin-bottom: 5px;">
          <div class="col-md-12"><img src="assets/image/tietkiem2.jpg" class="img-thumbnail"></div>
        </div>
        <div class="row">
          <div class="col-md-12"><img src="assets/image/tietkiem3.jpg" class="img-thumbnail"></div>
        </div>
      </div>
      <div class="col-md-9"> 
        <!-- slide -->
          ...
          <div class="item"> 
            ...
            <div id="myCarousel" class="carousel slide" data-ride="carousel"> 
              ...
              <div class="carousel-inner">
                <div class="item active"> <img src="assets/image/thanhvien.jpg" alt="Los Angeles"> </div>
                <div class="item"> <img src="assets/image/thanhvien1.jpg" alt="Los Angeles"> </div>
                <div class="item"> <img src="assets/image/thanhvien2.jpg" alt="Chicago"> </div>
                <div class="item"> <img src="assets/image/thanhvien.jpg" alt="New York"> </div>
              </div>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-4">
        ...
        <div class="info">
          ...
          <p>Có thể chuyển tiền qua các ví điện tử</p>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4">
        ...
        <div class="info">
          <h3>Khuyến mại</h3>
          <p>Khuyến mại gói trên 1.000.000đ</p>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4">
        ...
        <div class="info">
          ...
          <p>Nếu phát hiện hành vi gian lận</p>
        </div>
      </div>
    </div>
  </div>
...
<footer id="footer">
  ...
  <div class="bottom-footer">
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-5"> © Bản quyền DKT</div>
